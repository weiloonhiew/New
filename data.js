// Emotion Atlas data
// Structure inspired by the 13-category framework in Brené Brown's "Atlas of the Heart"
// (87 emotions and experiences grouped into 13 "places we go"). All descriptive text,
// predisposition patterns, body cues, and coaching questions below are original content
// written for coaching use — not quoted from the book.
...
const EMOTIONS = [
  ...
  { id:'stress', name:'Stress', category:'uncertain',
    ...
    questions:['What specifically feels like too much right now?','What would taking one thing off your plate look like?']
  },
  { id:'overwhelm', name:'Overwhelm', category:'uncertain',
    ...
    questions:['If you could only do one thing today, what would it be?','What’s the smallest possible next step?']
  },
  { id:'anxiety', name:'Anxiety', category:'uncertain',
    ...
    questions:['What’s the story you’re telling about what might happen?','What is actually within your control here?']
  },
  { id:'worry', name:'Worry', category:'uncertain',
    ...
    questions:['What would you need to know to set this worry down for now?','Whose input would actually help here?']
  },
  { id:'avoidance', name:'Avoidance', category:'uncertain',
    ...
    questions:['What are you protecting yourself from by not doing or saying this?','What would happen if you took the smallest step toward it?']
  },
  { id:'excitement', name:'Excitement', category:'uncertain',
    ...
    questions:['What about this are you most looking forward to?']
  },
  { id:'dread', name:'Dread', category:'uncertain',
    ...
    questions:['What’s the worst part of this for you?','What would make it 10% more bearable?']
  },
  { id:'fear', name:'Fear', category:'uncertain',
    ...
    questions:['What exactly feels threatening here?','What would help you feel even slightly safer right now?']
  },
  { id:'vulnerability', name:'Vulnerability', category:'uncertain',
    ...
    questions:['What would it look like to show up here without your armor on?']
  },
  ...
  { id:'comparison', name:'Comparison', category:'compare',
    ...
    questions:['Whose yardstick are you using right now?']
  },
  { id:'admiration', name:'Admiration', category:'compare',
    ...
    questions:['What quality in them would you like to grow in yourself?']
  },
  { id:'reverence', name:'Reverence', category:'compare',
    ...
    questions:['What does this bring up in you when you sit with it?']
  },
  { id:'envy', name:'Envy', category:'compare',
    ...
    questions:['What does their situation point to that you actually want for yourself?']
  },
  { id:'jealousy', name:'Jealousy', category:'compare',
    ...
    questions:['What relationship or connection feels at risk here?']
  },
  { id:'resentment', name:'Resentment', category:'compare',
    ...
    questions:['What boundary or ask have you not been able to voice directly?']
  },
  { id:'schadenfreude', name:'Schadenfreude', category:'compare',
    ...
    questions:['What need of yours gets met when you see them struggle?']
  },
  { id:'freudenfreude', name:'Freudenfreude', category:'compare',
    ...
    questions:['What made it easy to feel happy for them here?']
  },
  ...
  { id:'boredom', name:'Boredom', category:'unplanned',
    ...
    questions:['What would make this moment feel more alive to you?']
  },
  { id:'disappointment', name:'Disappointment', category:'unplanned',
    ...
    questions:['What specifically had you hoped would happen?']
  },
  { id:'expectations', name:'Expectations', category:'unplanned',
    ...
    questions:['Where did this expectation come from, and is it still serving you?']
  },
  { id:'regret', name:'Regret', category:'unplanned',
    ...
    questions:['What would you do differently, and what does that tell you about what you value?']
  },
  { id:'discouragement', name:'Discouragement', category:'unplanned',
    ...
    questions:['What’s one small sign of progress you’re not giving yourself credit for?']
  },
  { id:'resignation', name:'Resignation', category:'unplanned',
    ...
    questions:['What part of this do you actually still have influence over?']
  },
  { id:'frustration', name:'Frustration', category:'unplanned',
    ...
    questions:['What’s the block, and what have you already tried?']
  },
  ...
  { id:'awe', name:'Awe', category:'beyond-us',
    ...
    questions:['What did that moment put into perspective for you?']
  },
  { id:'wonder', name:'Wonder', category:'beyond-us',
    ...
    questions:['What are you most curious about right now?']
  },
  { id:'confusion', name:'Confusion', category:'beyond-us',
    ...
    questions:['What’s the piece that isn’t fitting together for you?']
  },
  { id:'curiosity', name:'Curiosity', category:'beyond-us',
    ...
    questions:['What draws you to explore this further?']
  },
  { id:'interest', name:'Interest', category:'beyond-us',
    ...
    questions:['What about this holds your attention most?']
  },
  { id:'surprise', name:'Surprise', category:'beyond-us',
    ...
    questions:['What did you expect instead, and what does the gap tell you?']
  },
  ...
  { id:'amusement', name:'Amusement', category:'not-what-they-seem',
    ...
    questions:['What made that land as funny to you?']
  },
  { id:'bittersweetness', name:'Bittersweetness', category:'not-what-they-seem',
    ...
    questions:['What are you celebrating, and what are you letting go of at the same time?']
  },
  { id:'nostalgia', name:'Nostalgia', category:'not-what-they-seem',
    ...
    questions:['What need from that time are you missing now?']
  },
  { id:'cognitive-dissonance', name:'Cognitive Dissonance', category:'not-what-they-seem',
    ...
    questions:['Where do your actions and your values feel out of step right now?']
  },
  { id:'paradox', name:'Paradox', category:'not-what-they-seem',
    ...
    questions:['What two true things are both present for you here?']
  },
  { id:'irony', name:'Irony', category:'not-what-they-seem',
    ...
    questions:['What’s the gap you’re noticing between what was expected and what happened?']
  },
  { id:'sarcasm', name:'Sarcasm', category:'not-what-they-seem',
    ...
    questions:['If you said that directly instead of sarcastically, what would you say?']
  },
  ...
  { id:'anguish', name:'Anguish', category:'hurting',
    ...
    questions:['You don’t have to explain it right now — what do you need in this moment?']
  },
  { id:'hopelessness', name:'Hopelessness', category:'hurting',
    ...
    questions:['Has there been any moment, even small, where it felt slightly different?']
  },
  { id:'despair', name:'Despair', category:'hurting',
    ...
    questions:['Who else is supporting you through this right now?'],
  ...
  { id:'sadness', name:'Sadness', category:'hurting',
    ...
    questions:['What is this sadness telling you that you needed or lost?']
  },
  { id:'grief', name:'Grief', category:'hurting',
    ...
    questions:['What would feel supportive to you right now, today?']
  },
  ...
  { id:'compassion', name:'Compassion', category:'with-others',
    ...
    questions:['What kind of support feels most helpful to offer here?']
  },
  { id:'pity', name:'Pity', category:'with-others',
    ...
    questions:['What would it look like to move from feeling sorry for them to standing with them?']
  },
  { id:'empathy', name:'Empathy', category:'with-others',
    ...
    questions:['What do you imagine they most need to feel heard right now?']
  },
  { id:'sympathy', name:'Sympathy', category:'with-others',
    ...
    questions:['What would it take to move closer to their experience rather than observing from a distance?']
  },
  { id:'boundaries', name:'Boundaries', category:'with-others',
    ...
    questions:['What boundary, if set clearly, would make this relationship more sustainable?']
  },
  { id:'comparative-suffering', name:'Comparative Suffering', category:'with-others',
    ...
    questions:['What would it look like to let your experience be valid without comparing it to anyone else’s?']
  },
  ...
  { id:'shame', name:'Shame', category:'fall-short',
    ...
    questions:['What’s the story you’re telling about what this means about you as a person?']
  },
  { id:'self-compassion', name:'Self-Compassion', category:'fall-short',
    ...
    questions:['What would you say to a friend in this exact situation?']
  },
  { id:'perfectionism', name:'Perfectionism', category:'fall-short',
    ...
    questions:['What would "good enough" look like here, and what makes that hard to accept?']
  },
  { id:'guilt', name:'Guilt', category:'fall-short',
    ...
    questions:['What action would help you make this right?']
  },
  { id:'humiliation', name:'Humiliation', category:'fall-short',
    ...
    questions:['What about this feels undeserved to you, and what do you need to feel restored?']
  },
  { id:'embarrassment', name:'Embarrassment', category:'fall-short',
    ...
    questions:['How funny will this seem in a week?']
  },
  ...
  { id:'belonging', name:'Belonging', category:'connection',
    ...
    questions:['Where do you feel most able to be fully yourself?']
  },
  { id:'fitting-in', name:'Fitting In', category:'connection',
    ...
    questions:['What part of yourself are you editing out to be accepted here?']
  },
  { id:'connection-emotion', name:'Connection', category:'connection',
    ...
    questions:['What made this connection feel real to you?']
  },
  { id:'disconnection', name:'Disconnection', category:'connection',
    ...
    questions:['When did you first notice the distance growing?']
  },
  { id:'insecurity', name:'Insecurity', category:'connection',
    ...
    questions:['What would help you feel more grounded in yourself right now?']
  },
  { id:'invisibility', name:'Invisibility', category:'connection',
    ...
    questions:['Where do you most want to be seen, and by whom?']
  },
  { id:'loneliness', name:'Loneliness', category:'connection',
    ...
    questions:['What kind of connection are you missing most right now?']
  },
  ...
  { id:'love', name:'Love', category:'heart-open',
    ...
    questions:['How are you nurturing this relationship right now?']
  },
  { id:'lovelessness', name:'Lovelessness', category:'heart-open',
    ...
    questions:['What would it take to let a little more love in right now?']
  },
  { id:'heartbreak', name:'Heartbreak', category:'heart-open',
    ...
    questions:['What do you need to grieve before you can move forward?']
  },
  { id:'trust', name:'Trust', category:'heart-open',
    ...
    questions:['What has this person done to earn your trust so far?']
  },
  { id:'self-trust', name:'Self-Trust', category:'heart-open',
    ...
    questions:['Where have you kept a promise to yourself recently?']
  },
  { id:'betrayal', name:'Betrayal', category:'heart-open',
    ...
    questions:['What was broken, specifically, and what would need to happen to rebuild it?']
  },
  { id:'defensiveness', name:'Defensiveness', category:'heart-open',
    ...
    questions:['What did you hear that felt like an attack, even if it wasn’t meant that way?']
  },
  { id:'flooding', name:'Flooding', category:'heart-open',
    ...
    questions:['What helps you come back to baseline when you’re this activated?']
  },
  { id:'hurt', name:'Hurt', category:'heart-open',
    ...
    questions:['What specifically was said or done that landed as hurtful?']
  },
  ...
  { id:'joy', name:'Joy', category:'life-good',
    ...
    questions:['What let you feel fully present for that moment of joy?']
  },
  { id:'happiness', name:'Happiness', category:'life-good',
    ...
    questions:['What conditions tend to bring out your happiness most reliably?']
  },
  { id:'calm', name:'Calm', category:'life-good',
    ...
    questions:['What practice helps you find calm when things get intense?']
  },
  { id:'contentment', name:'Contentment', category:'life-good',
    ...
    questions:['What about your current situation feels genuinely enough?']
  },
  { id:'gratitude', name:'Gratitude', category:'life-good',
    ...
    questions:['What’s one thing today you haven’t yet said thank you for?']
  },
  { id:'foreboding-joy', name:'Foreboding Joy', category:'life-good',
    ...
    questions:['What would it feel like to let yourself enjoy this without bracing for the other shoe to drop?']
  },
  { id:'relief', name:'Relief', category:'life-good',
    ...
    questions:['What tension are you most aware of releasing right now?']
  },
  { id:'tranquility', name:'Tranquility', category:'life-good',
    ...
    questions:['What helps you access this sense of peace, and how could you return to it more often?']
  },
  ...
  { id:'anger', name:'Anger', category:'wronged',
    ...
    questions:['What boundary or value feels like it’s been crossed here?']
  },
  { id:'contempt', name:'Contempt', category:'wronged',
    ...
    questions:['What would it take to see this person as fully human right now, even in disagreement?']
  },
  { id:'disgust', name:'Disgust', category:'wronged',
    ...
    questions:['What value of yours feels violated by this?']
  },
  { id:'dehumanization', name:'Dehumanization', category:'wronged',
    ...
    questions:['What would change if you had to describe this person to someone who loves them?']
  },
  { id:'hate', name:'Hate', category:'wronged',
    ...
    questions:['What need or fear sits underneath this intensity?']
  },
  { id:'self-righteousness', name:'Self-Righteousness', category:'wronged',
    ...
    questions:['Where might there be more than one valid way to see this?']
  },
  ...
  { id:'pride', name:'Pride', category:'self-assess',
    ...
    questions:['What effort of yours specifically led to this outcome?']
  },
  { id:'hubris', name:'Hubris', category:'self-assess',
    ...
    questions:['What would it feel like to let your work speak for itself without needing to inflate it?']
  },
  { id:'humility', name:'Humility', category:'self-assess',
    ...
    questions:['What’s something you’re still learning about this?']
  }
];
